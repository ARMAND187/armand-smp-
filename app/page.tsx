        ...
        >
          ...
          <div className="flex items-center gap-5">
            ...
            <a 
              ...
              aria-label="TikTok"
            >
              <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" stroke="none"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>
            </a>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col items-center md:items-start justify-center px-4 md:px-8 gap-3 pt-6 md:pt-0">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Kurdistan time. Saved rankings remain available while the server is offline.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center px-4 md:px-8 pt-6 md:pt-0">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full bg-[#111827] border border-[#334155] hover:bg-[#1E293B] hover:border-[#00E5FF]/50 text-slate-50 font-bold py-3 px-6 rounded-xl transition-all duration-200 hover:-translate-y-[2px] hover:shadow-[0_0_15px_rgba(0,229,255,0.15)] flex items-center justify-center gap-2 uppercase tracking-wide text-sm font-montserrat"
            >
