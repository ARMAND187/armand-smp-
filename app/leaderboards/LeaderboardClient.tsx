        ...
        <div className="mb-8 flex flex-col justify-between text-center md:flex-row md:items-end md:text-left">
          ...
          >
            ...
            <span className="mt-1 text-center text-[11px] leading-relaxed text-slate-400 md:text-left">
              {error ? "Saved rankings are still available. Retrying automatically." : online ? "Updates every 45 seconds. Times shown in Kurdistan time." : "Last saved rankings, shown in Kurdistan time. Waiting for the server to return."}
            </span>
          </div>
        </div>
